...
private:
    std::vector<VertexData> getCellMeshVertices(const Sdf& sdf, float x0, float y0, float z0,
    ...
    std::array<glm::vec3, 12> getIntersections(int cubeLookupIndex,
        const std::array<glm::vec3, 8>& vertices, const std::array<float, 8>& samples) const;
